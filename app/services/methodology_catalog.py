...
CATALOG = {
    ...
    "methodologies": [
        ...
        },
        {
            ...
            "recommended": True,
            "description": "Maximiza la utilidad cuadratica mu'w - 0.5*gamma*w'Sigma*w con gamma y max_weight por perfil de riesgo, segun el modelo academico del Informe 1.",
            ...
            "formula_legend": [
                {
                    ...
                    "description": "Vector de decision del optimizador. Cada w_i en [0, max_weight] y sum(w_i) = 1. max_weight y gamma dependen del perfil de riesgo. Resuelto por SLSQP (scipy.optimize).",
                    "source": "Variable calculada — no proviene de datos externos",
                },
                {
                    "symbol": "mu",
                    "name": "Retornos esperados anualizados",
                    "description": "Media de retornos diarios * 252 para cada accion del sub-universo. Usa el CAGR historico con fallback a media anualizada.",
                    "source": "Historical_Stocks/ — precios diarios ajustados por dividendos y splits",
                },
                {
                    "symbol": "gamma",
                    "name": "Coeficiente de aversion al riesgo",
                    "description": "Controla el trade-off retorno/riesgo por perfil. Muy conservador=60, Conservador=35, Neutro=18, Arriesgado=8, Muy arriesgado=4.",
                    "source": "Calibrado segun perfil — Informe 1 / solver academico",
                },
                {
                    "symbol": "Sigma",
            ...
            "notes": [
                ...
                "max_weight por perfil: Muy conservador=5%, Conservador=7%, Neutro=10%, Arriesgado=15%, Muy arriesgado=20%.",
            ],
            "parameters": [
                _parameter(
                    "cvar_beta_pct",
