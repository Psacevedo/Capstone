"""
scenarios.py — Proyeccion de retornos futuros bajo tres escenarios (Entrega 2, P4).

Escenarios proyectados:
  - Favorable:   retorno_anual = E[r] + 0.5 * sigma
  - Neutro:      retorno_anual = E[r]
  - Desfavorable: retorno_anual = E[r] - 0.5 * sigma

Simetricos alrededor del retorno base, consistente con el notebook
