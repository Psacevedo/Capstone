...
VISUAL_ASSETS = [
    {
        ...
        "caption": "Establece el sesgo sectorial del universo crudo previo al filtrado en cascada.",
    ...
    },
    {
        ...
        "kind": "Tabla",
        "page_number": 10,
        "summary": "Estadisticas por sector del universo final de acciones.",
...
REPORT_OUTLINE = {
    ...
    "summary": (
        ...
        "de riesgo, la formulacion del problema, el universo de acciones y la discusion "
    ...
    "profiles": [
        ...
        {"id": "muy_arriesgado", "label": "Muy arriesgado", "alpha_pct": 40, "summary": "Alta tolerancia al riesgo dentro del universo de acciones."},
    ],
