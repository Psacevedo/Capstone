...
ABANDONMENT_VERSION = "Version 3"
ABANDONMENT_FORMULA = "threshold_logistic_cap_10pct_k20"

ROLE_CALIBRATION = "calibracion"
ROLE_VALIDATION = "validacion"
ROLE_TEST = "test_p4"
FORCED_VIEW_KEY = "desempleo_macro"
    ...
    for _, row in metrics_df.iterrows():
        ...
        for _week in range(base.N_WEEKS):
            ...
            p_withdraw = np.where(
                ...
                0.10 / (1.0 + np.exp(-20.0 * (loss - profile.loss_tolerance))),
                0.0,
            )
