...
CAPSTONE_ROOT = WORK_DIR.parents[2]
...
def simulate_p4(metrics_df: pd.DataFrame) -> pd.DataFrame:
    ...
    for _, row in neutral.iterrows():
        ...
        company = np.where(active, INITIAL_CAPITAL * COMPANY_FEE_RATE, 0.0)
        ...
        for _week in range(N_WEEKS):
            ...
            company[idx] += accept_rec * wealth[idx] * TURNOVER_FRACTION * COMPANY_FEE_RATE
