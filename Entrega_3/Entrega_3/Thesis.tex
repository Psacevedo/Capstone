...
\mdate{Junio 26, 2026}         % date manuscript changed
\version{2}                                     % manuscript version #

\title[FINPUC \\ ENTREGA 3 \\ GRUPO 13]
   {\bf FINPUC \\ ENTREGA 3 \\ GRUPO 13}       
...
\cleardoublepage
\phantomsection\label{anexo:k}
\chapter*{Anexo N°5: Detalle de la simulación de sensibilidad de $K\%$}
\input{./chapters/ANEXO5.tex}

\cleardoublepage
\phantomsection\label{anexo:lambda}
\chapter*{Anexo N°6: Detalle de la optimización multiobjetivo de $\lambda$}
\input{./chapters/ANEXO6.tex}

\cleardoublepage
\phantomsection\label{anexo:calibracion}
\chapter*{Anexo N°7: Diagnósticos de la calibración secuencial de Black-Litterman}
\input{./chapters/ANEXO7.tex}
