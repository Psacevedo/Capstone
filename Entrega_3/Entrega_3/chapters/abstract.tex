...
($+85.7\%$ P4 score and $+5.2\%$ Sharpe versus the Markowitz base, average
figures), albeit with elevated turnover (34.6\%) and sector concentration
(HHI 0.261), while the unemployment-macro view provides superior operational
stability (7.3\% turnover, HHI 0.157). The recommended methodology is
Black-Litterman with the general-momentum view for aggressive profiles, with the
unemployment-macro view as a defensive alternative for conservative profiles.
