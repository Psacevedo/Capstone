...
econ\'omica: mejora el Score P4 en $+12.4\%$ bajo agregaci\'on mediana robusta y
en $+85.7\%$ bajo agregaci\'on promedio, adem\'as de mejorar el Sharpe en
$+5.2\%$ frente a Markowitz base. Esta ventaja exige monitorear su mayor
rotaci\'on (34.6\%) y concentraci\'on sectorial (HHI 0.261), mientras que
desempleo macro ofrece la mejor estabilidad operacional (7.3\% de turnover,
HHI 0.157). La sensibilidad con panoramas de retorno confirma que la
recomendaci\'on no depende de un \'unico retorno puntual. La metodolog\'ia
recomendada es Black-Litterman con la \textit{view} de momentum general para
perfiles agresivos, con desempleo macro como alternativa defensiva para perfiles
conservadores.
