...
\section{Caso base para la Entrega 3}

Para la evaluaci\'on de los nuevos par\'ametros de negocio, se define un caso
base adicional: Markowitz sin calibrar, con $K = 1\%$ y Score P4 sin
ponderaci\'on expl\'icita ($\lambda$ impl\'icito de 0.5 en el Score P4
original). Este caso base es el punto de comparaci\'on contra el cual se mide
la mejora obtenida al calibrar $K$ y $\lambda$. Las m\'etricas de referencia
para este caso base, medidas en el horizonte de test limpio, se presentan en
la Tabla~\ref{tab:p4_limpio_base}.

\begin{table}[h]
\centering
\caption{Score P4 del caso base (Markowitz sin calibrar, $K=1\%$) en test
limpio.}
\label{tab:p4_limpio_base}
\scriptsize
\begin{tabular}{@{}llrrrr@{}}
\toprule
Escenario & Perfil & Riqueza & Retiro & Utilidad & Score P4 \\
\midrule
Sin pandemia & Neutro & USD 2\,797 & 0.9\% & USD 194 & 2\,982 \\
Sin pandemia & Conservador & USD 2\,508 & 15.8\% & USD 196 & 2\,546 \\
Con pandemia & Conservador & USD 2\,369 & 13.0\% & USD 188 & 2\,427 \\
Con pandemia & Neutro & USD 2\,623 & 0.7\% & USD 176 & 2\,792 \\
\bottomrule
\end{tabular}
\end{table}